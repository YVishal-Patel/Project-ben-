    ...
    <div className="about-container">
      <div className="about-main-container container">
        ...
        <div className="about-main-container-data">
          ...
          <h2 style={{display:state?"none":"block"}} className='about-cont-data wow animate__fadeInUp'  data-wow-delay="0.3s">PLAY TO IMPACT IN THE REAL WORLD THROUGH GAMING</h2>
